...
In this assignment, you'll create Hangman. This app will run in the browser, and feature dynamically updated HTML and CSS powered by your JavaScript code.
...
2. Inside your local git repository, create an `index.html`. For this assignment, we've given you a starter template in the 'Unsolved' folder.
